...
mvn exec:java -f /usr/local/SANSA-DataLake_example/SQLtoNOSQL/pom.xml -X -Dexec.args="/root/data/input/09Person.sql Person /root/input/config"

echo "***************************Loading data to Parquet***********************"
mvn exec:java -f /usr/local/SANSA-DataLake_example/SQLtoNOSQL/pom.xml -X -Dexec.args="/root/data/input/10Review.sql Review /root/input/config"
...
mvn exec:java -X -f /usr/local/SANSA-DataLake_example/SQLtoNOSQL/pom.xml -Dexec.args="/root/data/input/04Product.sql Product /root/input/config"

echo "***************************Loading data to MongoDB***********************"
mvn exec:java -X -f /usr/local/SANSA-DataLake_example/SQLtoNOSQL/pom.xml -Dexec.args="/root/data/input/08Offer.sql Offer /root/input/config"
